...
import InformationSub from '@/components/InformationSub';
...
let router = new Router({
    routes: [
        ...
        {
            path: '/information-sub',
            meta: {
                title: '信息提交',
                whiteList: true
            },
            name: 'InformationSub',
            component: InformationSub
        },
        {
...
router.beforeEach((to, from, next) => {
    ...
    localStorage.setItem('navigate_item', to.fullPath);
    localStorage.setItem('navigate_name', to.name);
    localStorage.setItem('navigate_path', to.path);
    if (version) {
