                    ...
                    <ul>
                        <li class="item-content">
                            <div class="item-inner">
                                ...
                                <div class="item-select">
                                    <input id="from_Account" class="input-amount" type="text" maxlength="80" :placeholder="$t('transfer.from')" value="">
                                </div>
                        ...
                        <li class="item-content">
                            <div class="item-inner">
                                ...
                                <div class="item-input">
                                    <input id="to_Account"  change="onAccountChange1" class="input-account"  type="text" maxlength="80" :placeholder="$t('transfer.to_placeholder')" value="">
                                </div>
                                <div class="item-after">
                        ...
                        <li class="item-content last">
                            <div class="item-inner">
                                ...
                                <div class="item-input">
                                    <input id="to_Amount"  change="onAmountChange" class="input-amount" model="amount" type="number" maxlength="80" :placeholder="$t('transfer.amount_placeholder')" value="10000">
                                </div>
                            </div>
                        </li>
