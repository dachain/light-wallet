            ...
            <div class="center-content">
                <div class="content-block">
                    <div class="item-input">
                        <input class="input-amount" type="number" maxlength="80"  v-model="amount" @keyup="limitLength">
                    </div>
                    <div class="text-center">
                        <qrcode :val="qrcode" :size="160"></qrcode>
                        <p style="word-break: break-all;">{{$t('index.account_name')}}: {{this.account.name}}</p>
                        <p style="word-break: break-all;">{{$t('index.account_address')}}:&nbsp;{{this.account.account}}</p>
                    </div>
                    <div class="content-block">
                        <p v-if="isNative">
