    ...
    <div class="page-group">
        <div class="page" id="page-wallet-import">
            <header class="bar bar-nav">
                <h3 class="title">{{$t('mnemonic.title')}}</h3>
                                ...
                                <div class="item-inner">
                                    <div class="item-input item-required">
                                        ...
                                        <textarea id="Wallet_keystore" v-model="wifKey"
                                                  :placeholder="$t('mnemonic.placeholder.key')"
                            ...
                            <div class="item-content">
                                <div class="item-inner">
                                    ...
                                    <div class="item-input">
                                        <input v-model="account" type="text" maxlength="30"
                                               :placeholder="$t('mnemonic.placeholder.password')">
                                    </div>
                                </div>
                            </div>
                        </li>
                ...
                <div class="content-block block-button">
                    <p class="content-block">
                        <a @click="onSubmit" href="javascript:;" class="button button-gxb"
                           :class="{disabled:!isCommitEnable}">{{$t('mnemonic.submit')}}</a>
                    </p>
                </div>
            </div>
        </div>
