const locale = {
    ...
    wallet_create: {
        index: {
            title: 'Wallet',
            tip_empty: 'DACTS Wallet was not created',
    ...
    about: {
        ...
        version: 'V1.0.1',
        desc: {
            line1: 'DACTS Wallet is a lite mobile wallet APP ',
            line2: 'to facilitate DACTS transfer, collection, wallet management',
            line3: 'and review of updates on DACTS at any time.'
        },
    ...
    disclaimer: {
        ...
        content: '<h4 class="text-center">Notice to Use and Disclaimer</h4>' +
            '<p>DACTS Wallet is a decentralized blockchain application. Please acquire a full understanding of the blockchain technology before use. Make sure you have the basic competence to use and manage decentralized wallet on a reasonable level.</p>' +
            '<p>1. Once DACTS Wallet account or password is lost, it is unable to retrieve. Please keep properly your account and password, and make sure to back up your private key to the wallet, which is the only credential to get back your wallet. DAChain is not responsible for the loss or theft of the wallet due to your failure to back up the private key, safekeep or properly use the wallet.</p>' +
            '<p>2. If you obtain DACTS Wallet app or any other application under the same name of this sofeware from any unauthorized third party, DACT will not vouch for its security. You will be responsible for the loss inflicted thereby. </p>' +
            '<p>3. By transferring DACTS via DACTS wallet, you understand the IRRETRIEVABLE attribute of blockchain-based operation and will be responsible for irreversible loss due to your misoperation.</p>' +
            '<p>4. You shall comply with relevant state laws, policies and regulations when trading on DACTS Wallet.</p>',
    ...
    transfer: {
        ...
        available: '<span class="color-danger">{amount}</span> DACTS Available',
        memo: 'Memo',
        fee: 'Fee',
    ...
    loyalty_program: {
        ...
        tip3: 'DACT\'s Loyalty Program is a benefit program designed for investors to lock up certain amount of DACTS (GX Share). During the lockup period, the capital is frozen, meanwhile investors are entitled to extra bonus. For example, lock up 10,000 DACTS for 9 months; calculating by 6% annualized return,  you may get 450 DACTS for bonus on the due date. DACTS would like our investors to join the Loyalty Program and enjoy the long-term benefits brought by DACT\'s growth in the future.',
        ...
        available: '<span class="color-danger">{amount}</span> DACTS Available',
        reward: '<span class="color-danger">{amount}</span> DACTS Reward',
        join: 'Setup',
        history: 'History',
        no_record: 'No record',
        locked_at: 'Locked At',
        locked_amount: 'Locked Amount(DACTS)',
        ...
        success: {
            title: 'Success',
            message: 'Congratulations,{amount} DACTS were locked for join loyalty program'
        },
        detail: {
            title: 'Program Details',
            success: {
                title: 'Success',
                message: 'Congratulations,{amount} DACTS were unlocked.'
            }
        }
    },
    realtime_quotations: {
