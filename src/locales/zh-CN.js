const locale = {
    ...
    about: {
        ...
        version: 'V1.0.1',
        desc: {
            line1: 'DACT Wallet是一款移动端轻钱包APP，',
            line2: '通过它能实现DACT的转账、收款和钱包管理，',
            line3: '并及时掌握DACT的最新动态。'
        },
        disclaimer: '免责声明'
    },
    disclaimer: {
        ...
        content: '<h4 class="text-center">使用须知和免责声明</h4>' +
            '<p>DACT钱包是去中心化区块链应用，在您使用之前，请充分了解区块链科技知识，具备合理使用和管理去中心化钱包的基本能力。</p>' +
            '<p>一、DACT钱包账户和密码一旦丢失不可找回，请妥善保管好您的账户和密码，并务必备份好钱包的私钥。私钥是找回钱包的唯一凭证！因未备份私钥、未妥善保管或因操作不当而造成钱包丢失或被盗的情况，公信宝概不负责。</p>' +
            '<p>二、如果您从未经授权的第三方获取DACT钱包APP或与本软件名称相同的应用程序，公信宝将无法保证软件的安全性，因此造成的损失由您自行承担。</p>' +
            '<p>三、使用DACT钱包发送DACT等功能时，您应理解区块链操作“不可撤销”属性，并自行承担因操作失误而导致结果不可逆的损失。\n</p>' +
            '<p>四、在DACT钱包上交易时，您应当遵循有关国家政策、法律法规的要求。</p>',
        accept: '我已阅读并同意'
    },
    unlock: {
    ...
    Information_sub: {
        ...
        to_name: '填写姓名',
        to_mobile: '手机号',
        to_cell_phone_number: '填写手机号',
        card_id: '身份证号',
        to_card_id: '填写身份证号',
        bank_card: '银行卡号',
        to_bank_card: '填写银行卡号',
        plate_number: '车牌号',
        to_plate_number: '填写车牌号',
        submit_info: '提交信息',
        memo: '备注(MEMO)',
        memo_placeholder: '选填'
    },
    ...
    transfer: {
        ...
        amount: '发送数量',
        amount_placeholder: '填写DACT数量',
        receive_amount: '填写接收DACT数量',
        available: '可用: <span class="color-danger">{amount}</span> DACT',
        memo: '备注(MEMO)',
        fee: '手续费',
        memo_placeholder: '选填',
        next: '下 一 步',
    ...
    loyalty_program: {
        ...
        tip3: '忠诚计划是公信宝推出的一项福利计划，投资者可锁定一定额度的DACT，锁定期间金额冻结，同时享受对应的奖励。如锁定1万DACT9个月，按年化6%，到期后可获得450个DACT的奖励。公信宝希望投资者通过忠诚计划，享受未来公信宝发展所带来的长期效益！',
        ...
        amount: '锁定金额',
        available: '可用: <span class="color-danger">{amount}</span> DACT',
        reward: '奖励: <span class="color-danger">{amount}</span> DACT',
        join: '设置计划',
        history: '锁定记录',
        no_record: '无记录',
        locked_at: '锁定时间',
        locked_amount: '锁定金额(DACT)',
        ...
        success: {
            title: '参与成功',
            message: '成功锁定 {amount} DACT'
        },
        detail: {
            title: '锁定详情',
            success: {
                title: '提示',
                message: '恭喜，成功解锁 {amount} DACT'
            }
        }
    },
    realtime_quotations: {
